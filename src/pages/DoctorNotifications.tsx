...
import { ArrowLeft, Bell, Check, Trash2, Video, Calendar, MessageSquare, Stethoscope } from 'lucide-react';
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <h1 className="text-2xl font-bold text-foreground">Doctor Notifications</h1>
              </div>
            </div>
      ...
      <main className="container mx-auto px-4 py-8">
        {notifications.length === 0 ? (
          <div className="text-center py-16">
            ...
            <p className="text-muted-foreground">You're all caught up! No pending patient requests.</p>
          </div>
        ) : (
